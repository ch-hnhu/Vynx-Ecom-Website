// Expose functions to window object for React components to use
window.initCarousels = window.initCarousels || {};

(function ($) {
	"use strict";

	// Initiate the wowjs on page load
	new WOW().init();
	...
	// Exposed function: Hero Header carousel
	window.initCarousels.header = function () {
	...
	// Exposed function: ProductList carousel
	window.initCarousels.productList = function () {
	...
	// Exposed function: ProductList categories carousel
	window.initCarousels.productImg = function () {
	...
	// Exposed function: Single Products carousel
	window.initCarousels.single = function () {
