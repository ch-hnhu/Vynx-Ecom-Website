			...
			<DialogContent dividers>
				...
				<Box mb={3}>
					<Typography
						variant='h6'
						gutterBottom
						sx={{ color: "#234C6A", fontWeight: "bold" }}>
						Thông tin chung
					</Typography>
						...
						<Grid size={6}>
							...
							<Typography variant='body1' fontWeight='medium'>
								{order.user?.role === "admin"
									...
									: order.user?.phone || order.shipping_phone || "N/A"}
							</Typography>
						</Grid>
						<Grid size={6}>
							<Typography variant='body2' color='text.secondary'>
				...
				<Box mb={3}>
					...
					{order.user_address ? (
						...
						<Box>
							...
							<Typography variant='body2' color='text.secondary' sx={{ mt: 1 }}>
								Điện thoại: {order.shipping_phone || "N/A"}
							</Typography>
							{order.shipping_note && (
								<Typography
									variant='body2'
					...
					<Grid container spacing={2}>
						<Grid size={6}>
							...
							<Chip
								...
								color={
									paymentStatusColors[getPaymentStatusName(order.payment_status)]
								}
								size='small'
							/>
						</Grid>
