...
// Trong admin, ta cũng cần URL này để hiển thị ảnh
...
export default function AdminProfile() {
    ...
    const handleSave = async (e) => {
        ...
        try {
            ...
            localStorage.setItem("user_data", JSON.stringify(updatedUser)); // Cập nhật localStorage cho admin nếu logic auth dùng nó.
            // Lưu ý: authService của admin có thể dùng key khác, cần kiểm tra.
            // Ở file Header.jsx của Admin, useEffect lắng nghe sự kiện "storage".
            // authService.js của User dùng localStorage key "user_data"? Cần check authService của Admin.
            // Nhưng tạm thời cứ dispatch event để Header update.
                            ...
                            <form onSubmit={handleSave}>
                                <div className="row">
                                    ...
                                    <div className="col-md-4 text-center mb-4">
                                        ...
                                        <h3 className="profile-username text-center">{formData.full_name || 'Admin'}</h3>
                                        <p className="text-muted text-center">{formData.username}</p>

                                        <div className="mt-3">
                                            <label htmlFor="imageInput" className="btn btn-primary btn-sm btn-block">
                                                <i className="fas fa-camera me-2"></i><b>Chọn ảnh mới</b>
                                            </label>
                                            <input
                                                type="file"
                                                id="imageInput"
